var fgm = {
    ...
    index: function () {
        var aChildred = element.parentNode.children, i;
        for (i = 0; i < aChildred.length; i++) {
            if (aChildred[i] === Element) {
                return i;
            }
        }
        return -1;
...
Tab.prototype = {
    ...
    fnSwitch: function () {
        ...
        thsi.aItems[this.iNow].style.display = "block";
