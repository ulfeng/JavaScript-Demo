...
ZoomPic.prototype = {
    initialize: function (id) {
        ...
        // Array unshift在数组头添加一个或多个元素并返回数组长度
        // shift 删除数组头部的第一个元素，并返回第一个元素
        // push 在数组尾部添加一个或多个元素并返回数组长度
        // pop 删除数组尾部最后的一个元素，并返回最后一个元素
        this.aSort.unshift(this.aSort.pop());
        this.setUp();
        this.addEvent(this.prev, "click", this._doPrev);
        this.addEvent(this.next, "clcik", this._doNext);
        this.doImgClick();
    ...
    setUp: function () {
        ...
        for (i = 0; i < this.aSort.length; i++) {
                    ...
                    _this.doMove(_this.aSort[_this.iCenter].getElementsByTagName("img")[0], { opacity: 100 }, function () {
                        _this.doMove(_this.aSort[_this.iCenter].getElementsByTagName)("img")[0], { opacity: 100 }, function () {
                            _this.aSort[_this.iCenter].onmouseover = function () {
                                _this.doMove(this.getElementById("div")[0], { bottom: 0 });
                            };
            ...
            if (i < this.iCenter || i > this.iCeneter) {
        ...
        if (arguments.length == 2) {
            ...
            switch (attr) {
                ...
                case "bottom":
                    ...
                    break;
                case "opacity":
                    oElement.style.fliter = "alpha(opacity=" + value + ")";
